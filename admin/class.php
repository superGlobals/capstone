...
include('includes/class_sidebar.php'); 
            ...
            <?php endif?>
                ...
                <section class="section">
                    <div class="card ml-3 mr-3">
                        ...
                        <a id="addbtn" href="#addclass" style=" width: 150px;  
                         margin-top: 20px;" data-toggle="modal" class="btn btn-primary ">Add Class</a>
                        <div class="card-body">
                        ...
                        <?php
                            ...
                            while($row = $query->fetch_assoc()){
                                ...
                                "<tr>                                  
                                    ...
                                    <td>
                                        <a href='#editclass_".$row['class_id']."' class='btn btn-success' data-toggle='modal'><i class='far fa-edit'></i></a>
                                        <a href='#deleteclass_".$row['class_id']."' class='btn btn-danger' data-toggle='modal'><i class='far fa-trash-alt'></i></a>
                                    </td>
                                </tr>";
