...
include("includes/department_sidebar.php");
?>
<style type="text/css">
                ...
                <section class="section">
                    <div class="card ml-3 mr-3">
                        <div style="background: #374c9d;" class="card-header" >
                          ...
                          <a id="addbtn" href="#adddept" style=" width: 150px;  
                         margin-top: 20px;" data-toggle="modal" class="btn btn-primary ">Add Department</a>
                        <div class="card-body">
                        ...
                        <?php
                            ...
                            while($row = $query->fetch_assoc()){
                                ...
                                "<tr>                                  
                                    ...
                                    <td>".$row['p-incharge']."</td>
                                    <td>
                                        <a href='#editdept_".$row['department_id']."' class='btn btn-success' data-toggle='modal'><i class='far fa-edit'></i></a>
                                        <a href='#deletedept_".$row['department_id']."' class='btn btn-danger' data-toggle='modal'><i class='far fa-trash-alt'></i></a>
                                    </td>
                                </tr>";
