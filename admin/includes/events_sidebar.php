...
<li class="nav-item active">
  <a style="background: #ffcb01; color: white; padding: 10px; border-radius: 0px  20px 20px 0px;" class="nav-link" href="events.php">
    <i class="fas fa-calendar-alt"></i>
    <span>Events</span></a>
</li>
<!-- Divider -->
...
<!-- End of Sidebar -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Topbar -->
        <nav class="navbar navbar-expand navbar-light bg-light topbar mb-4 static-top shadow" style="height: 40px;">
          ...
          <!-- Topbar Search -->
          <h5 class="text-dark mt-2">Calendar of Events</h5>
