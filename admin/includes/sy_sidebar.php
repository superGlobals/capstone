...
<li class="nav-item active">
  <a style="background: #ffcb01; color: white; padding: 10px; border-radius: 0px  20px 20px 0px;" class="nav-link" href="school_year.php">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand topbar mb-4 static-top shadow" style="height: 40px; background: #ffcb01;">
          ...
          <!-- Topbar Search -->
          <h5 class="text-dark mt-2">School year page</h5>
