...
if ($count > 0){
		$_SESSION['validate'] = "Class Already Added!";		
		header("location: home.php");
}else{

mysqli_query($conn,"insert into teacher_class (teacher_id,subject_id,class_id,thumbnails,school_year) values('$session_id','$subject_id','$class_id','img/logo.jpg','$school_year')")or die(mysqli_error());
