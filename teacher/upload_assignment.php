...
<?php include('upload_assignment_sidebar.php');?>
    ...
    <h1 id="welcome-title"> <?php
        ...
        <section id="grid-container" style="margin-top: 20px; width: 100%;">
         ...
         <div style="background: #374c9d;" class="panel-heading">
                <h4 class="panel-title">
                   <p style="padding-top: 10px; margin-left: 10px; color: white;" data-toggle="collapse" data-parent="#accordion" href="#collapse1">Upload Assignment</p>
        </h4>
        ...
        <div class="panel-body"><strong></strong>
          <form class="" id="add_downloadble" method="post" enctype="multipart/form-data" name="upload" >
                        <div class="control-group">
                            <label class="control" for="inputEmail">File:</label>
                            <div class="controlas">
      ...
      jQuery(document).ready(function($){
        $("#add_downloadble").submit(function(e){
          ...
          $.ajax({
            type: "POST",
            url: "upload_assignment_save.php",
            data: formData,
